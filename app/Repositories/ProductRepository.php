...
class ProductRepository
{
    ...
    public array $productRelationAttributes = ['brand', 'category', 'condition', 'productSizes.size', 'colours', 'fulfillmentOptions', 'hiringDetail.unavailabilityDays', 'user:id,name', 'reviews.user:id,name', 'media'];
